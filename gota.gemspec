...
Gem::Specification.new do |spec|
  ...
  spec.homepage      = 'https://git.sr.ht/~easbarbosa/gota'
  spec.required_ruby_version = Gem::Requirement.new('>= 2.7')
  spec.license = 'GPL-3.0'

  # spec.metadata["allowed_push_host"] = "TODO: Set to 'https://mygemserver.com'"

  spec.metadata["homepage_uri"] = 'https://git.sr.ht/~easbarbosa/gota'
  spec.metadata["source_code_uri"] = 'https://git.sr.ht/~easbarbosa/gota'
  spec.metadata["changelog_uri"] = "https://git.sr.ht/~easbarbosa/gota/refs/v#{spec.version}/History.rdoc"
